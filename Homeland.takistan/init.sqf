        ...
        if (_target getVariable ["canManufacture", true]) then {
           ...
           [_target, "FactorySound"] remoteExec ["say3D", 0];
            ...
            [_target] spawn {
                ...
                private _crate4 = createVehicle ["rhs_7ya37_1_single", getMarkerPos "marker_22", [], 0, "CAN_COLLIDE"];
                _crate4 setVariable ["ace_cargo_customName", "Empty", true];

                clearWeaponCargoGlobal _crate4;
                clearMagazineCargoGlobal _crate4;
                clearItemCargoGlobal _crate4;
                clearBackpackCargoGlobal _crate4;
    ...
    "Manufacture Rifle Supply Crate",
    {
        ...
        if (_target getVariable ["canManufacture", true]) then {
           ...
           [_target, "FactorySound"] remoteExec ["say3D", 0];
            ...
            private _crate5 = createVehicle ["rhs_7ya37_1_single", getMarkerPos "marker_22", [], 0, "CAN_COLLIDE"];
            _crate5 setVariable ["ace_cargo_customName", "Rifle Squad Supply Crate", true];
            _crate5 setVariable ["ace_cargo_noRename", true];

            clearWeaponCargoGlobal _crate5;
            clearMagazineCargoGlobal _crate5;
            clearItemCargoGlobal _crate5;
            clearBackpackCargoGlobal _crate5;

            _crate5 addWeaponCargoGlobal ["rhs_weap_ak74m", 2];
            _crate5 addWeaponCargoGlobal ["rhs_weap_rpg75", 2];
            _crate5 addMagazineCargoGlobal ["rhs_30Rnd_545x39_7N22_AK", 20];
            _crate5 addMagazineCargoGlobal ["rhs_60Rnd_545x39_7N22_AK", 10];
            _crate5 addMagazineCargoGlobal ["rhs_VOG25", 20];
            _crate5 addMagazineCargoGlobal ["rhs_GRD40_white", 10];
            _crate5 addMagazineCargoGlobal ["rhssaf_mag_br_m75", 10];
            _crate5 addMagazineCargoGlobal ["rhssaf_mag_brd_m83_white", 10];
            _crate5 addItemCargoGlobal ["ACE_elasticBandage", 20];
            _crate5 addItemCargoGlobal ["ACE_packingBandage", 20];
            _crate5 addItemCargoGlobal ["ACE_morphine", 5];
            _crate5 addItemCargoGlobal ["ACE_epinephrine", 5];
            _crate5 addItemCargoGlobal ["ACE_tourniquet", 5];
            _crate5 addItemCargoGlobal ["ACE_splint", 5];
            _crate5 addItemCargoGlobal ["ACE_EarPlugs", 3];
            _crate5 addItemCargoGlobal ["ACE_suture", 20];
            _crate5 addItemCargoGlobal ["ACE_salineIV_500", 5];
            _crate5 addMagazineCargoGlobal ["murshun_cigs_cigpack", 1];
    ...
    "Manufacture Weapons Supply Crate",
    {
        ...
        if (_target getVariable ["canManufacture", true]) then {
           ...
           [_target, "FactorySound"] remoteExec ["say3D", 0];
            ...
            private _crate7 = createVehicle ["rhs_7ya37_1_single", getMarkerPos "marker_22", [], 0, "CAN_COLLIDE"];
            _crate7 setVariable ["ace_cargo_customName", "Weapons Squad Supply Crate", true];
            _crate7 setVariable ["ace_cargo_noRename", true];

            clearWeaponCargoGlobal _crate7;
            clearMagazineCargoGlobal _crate7;
            clearItemCargoGlobal _crate7;
            clearBackpackCargoGlobal _crate7;
            
            _crate7 addMagazineCargoGlobal ["rhssaf_250Rnd_762x54R", 4];
            _crate7 addMagazineCargoGlobal ["rhs_rpg7_PG7VS_mag", 6];
            _crate7 addMagazineCargoGlobal ["rhs_rpg7_type69_airburst_mag", 3];
            _crate7 addMagazineCargoGlobal ["rhs_rpg7_TBG7V_mag", 3];
            _crate7 addMagazineCargoGlobal ["rhs_rpg7_OG7V_mag", 2];
            _crate7 addItemCargoGlobal ["ACE_EarPlugs", 3];
            _crate7 addItemCargoGlobal ["ACE_canteen", 1];
            _crate7 addMagazineCargoGlobal ["murshun_cigs_cigpack", 1];
    ...
    "Manufacture Medical Supply Crate",
    {
        ...
        if (_target getVariable ["canManufacture", true]) then {
           ...
           [_target, "FactorySound"] remoteExec ["say3D", 0];
            ...
            private _crate6 = createVehicle ["ACE_medicalSupplyCrate_advanced", getMarkerPos "marker_22", [], 0, "CAN_COLLIDE"];

                clearWeaponCargoGlobal _crate6;
                clearMagazineCargoGlobal _crate6;
                clearItemCargoGlobal _crate6;
                clearBackpackCargoGlobal _crate6;

                _crate6 addItemCargoGlobal ["ACE_elasticBandage", 75];
                _crate6 addItemCargoGlobal ["ACE_packingBandage", 75];
                _crate6 addItemCargoGlobal ["ACE_quikclot", 75];
                _crate6 addItemCargoGlobal ["ACE_bodyBag", 5];
                _crate6 addItemCargoGlobal ["ACE_CableTie", 25];
                _crate6 addItemCargoGlobal ["ACE_morphine", 25];
                _crate6 addItemCargoGlobal ["ACE_epinephrine", 25];
                _crate6 addItemCargoGlobal ["ACE_salineIV", 40];
                _crate6 addItemCargoGlobal ["ACE_salineIV_500", 40];
                _crate6 addItemCargoGlobal ["ACE_tourniquet", 16];
                _crate6 addItemCargoGlobal ["ACE_splint", 16];
                _crate6 addItemCargoGlobal ["ACE_EarPlugs", 3];
                _crate6 addItemCargoGlobal ["ACE_suture", 100];
                _crate6 addItemCargoGlobal ["ACE_surgicalKit", 4];
                _crate6 addItemCargoGlobal ["ACE_painkillers", 15];
                _crate6 addItemCargoGlobal ["ACE_suture", 100];
                _crate6 addMagazineCargoGlobal ["murshun_cigs_cigpack", 1];
    ...
    "Manufacture Spare Wheel",
    {
        ...
        if (_target getVariable ["canManufacture", true]) then {
           ...
           [_target, "FactorySound"] remoteExec ["say3D", 0];
            ...
            createVehicle ["ACE_Wheel", getMarkerPos "marker_22", [], 0, "CAN_COLLIDE"];
    ...
    "Manufacture Spare Track",
    {
        ...
        if (_target getVariable ["canManufacture", true]) then {
           ...
           [_target, "FactorySound"] remoteExec ["say3D", 0];
            ...
            createVehicle ["ACE_Track", getMarkerPos "marker_22", [], 0, "CAN_COLLIDE"];
